...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post(`${process.env.REACT_APP_API}/api/1/auth/register`, {
                name,
                email,
                password,
                phone,
...
//         e.preventDefault();
//         try {
//             const res = await axios.post(`${process.env.REACT_APP_API}/api/1/auth/register`, { name, email, password, phone, address });
//             if (res && res.data.success) {
